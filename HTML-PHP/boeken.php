...
<form method="GET">
    ...
    <?php
    /// Updated code to use the new "rating" column instead of "beoordeling".
    // The previous code worked with the old database column, but after renaming, it no longer worked correctly.
